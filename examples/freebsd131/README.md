...
When choosing a cloud-native OS you might not think of [FreeBSD](https://freebsd.org), however it supports the same industry standard metadata interfaces for instance configurations as Linux, [Cloud-Init](https://cloud-init.io). This allows you to automate your [FreeBSD](https://freebsd.org) workloads, in a simlar fashion to other operating system options.  This meams [FreeBSD](https://freebsd.org) is perfectly suitable when using on a cloud platform.
